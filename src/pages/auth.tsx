...
export default function Auth() {
    ...
    return (
        <>
            <Head>
                <title>{hasAccount === 'login' ? 'Log In | CVLord' : 'Sign Up | CVLord'}</title>
            </Head>
            <div className='flex justify-center h-auto'>
                <div className='bg-backgroundSecondary rounded-lg px-16 py-16 my-auto lg:2-2/5 lg:max-w-md rounded-md w-[90%]'>
                    ...
                    <button 
                        type='submit' 
                        onClick={hasAccount === 'login' ? login : register} 
                    ...
                    <div className='flex flex-row items-center gap-4 mt-8 justify-center'>
                        <div
                            onClick={hasAccount === 'login' ?  () => signIn('google', { callbackUrl: '/' }) : () => signIn('google', { callbackUrl: '/username' })} 
                            className='
                                w-8
                                h-8
                                bg-transparent
                        ...
                        <div
                            onClick={hasAccount === 'login' ?  () => signIn('github', { callbackUrl: '/' }) : () => signIn('github', { callbackUrl: '/username' })} 
                            className='
                                w-8
                                h-8
                                bg-transparent
                        ...
                        <div
                            onClick={hasAccount === 'login' ?  () => signIn('linkedin', { callbackUrl: '/' }) : () => signIn('linkedin', { callbackUrl: '/username' })} 
                            className='
                                w-8
                                h-8
                                bg-transparent
