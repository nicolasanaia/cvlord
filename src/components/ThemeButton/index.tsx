    ...
    return (
        <div className='mr-1'>
            ...
            {mode === 'dark' ? (
                ...
                <svg className='stroke-fontPrimary h-7 w-7 transition duration-150 ease-in-out hover:stroke-highlightPrimary' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2}>
